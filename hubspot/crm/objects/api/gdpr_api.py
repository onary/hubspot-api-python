...
class GDPRApi(object):
    ...
    def post_crm_v3_objects_object_type_gdpr_delete(self, object_type, public_gdpr_delete_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.post_crm_v3_objects_object_type_gdpr_delete(object_type, public_gdpr_delete_input, async_req=True)
        >>> result = thread.get()
        ...
        return self.post_crm_v3_objects_object_type_gdpr_delete_with_http_info(object_type, public_gdpr_delete_input, **kwargs)  # noqa: E501

    def post_crm_v3_objects_object_type_gdpr_delete_with_http_info(self, object_type, public_gdpr_delete_input, **kwargs):  # noqa: E501
        """GDPR DELETE  # noqa: E501

        Permanently delete a contact and all associated content to follow GDPR. Use optional property 'idProperty' set to 'email' to identify contact by email address. If email address is not found, the email address will be added to a blocklist and prevent it from being used in the future.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_crm_v3_objects_object_type_gdpr_delete_with_http_info(object_type, public_gdpr_delete_input, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method post_crm_v3_objects_object_type_gdpr_delete" % key)
        ...
        if self.api_client.client_side_validation and ("object_type" not in local_var_params or local_var_params["object_type"] is None):  # noqa: E501  # noqa: E501
            raise ApiValueError("Missing the required parameter `object_type` when calling `post_crm_v3_objects_object_type_gdpr_delete`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ("public_gdpr_delete_input" not in local_var_params or local_var_params["public_gdpr_delete_input"] is None):  # noqa: E501  # noqa: E501
            raise ApiValueError("Missing the required parameter `public_gdpr_delete_input` when calling `post_crm_v3_objects_object_type_gdpr_delete`")  # noqa: E501
